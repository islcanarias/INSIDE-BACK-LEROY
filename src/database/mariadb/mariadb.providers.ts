...
export const MariadbProviders: Provider[] = [
    ...
    },
    {
        provide: 'leroy_db',
        useValue: mariadb.createPool({
            host: process.env.MARIADB_LEROY_DB_HOST,
            user: process.env.MARIADB_LEROY_DB_USER,
            password: process.env.MARIADB_LEROY_DB_PASS,
            database: process.env.MARIADB_LEROY_DB_DATABASE,
            port: Number(process.env.MARIADB_LEROY_DB_PORT)
        }),
    },
